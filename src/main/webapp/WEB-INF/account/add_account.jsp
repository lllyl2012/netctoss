...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" media="all" href="../styles/other.css" />
    	...
    	function check_idcardno() {
    		...
    		//验证身份证是否为空
    		if(idcard_no=="") {
    			$("#idcard_no_msg").text("身份证不能为空.").addClass("error_msg2");
    			return;
    		}
    		//验证身份证格式
    		var reg = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/;
    		if(!reg.test(idcard_no)) {
    			$("#idcard_no_msg").text("身份证格式不正确.").addClass("error_msg2");
    			return;
    		}
    		//验证通过，给予正确提示
    		$("#idcard_no_msg").text("有效的身份证.").removeClass("error_msg2");
    		//截取生日
    		//123456198103041234 -> 1981-03-04
    ...
    <body>
        ...
        <div id="main">       
            ...
            <form action="addAccount.do" method="post" class="main_form">
                ...
                <div class="input_info">
                    <input type="text" name="idcard_no" value="" id="idcard_no" onblur="check_idcardno();"/>
                    <span class="required">*</span>
                    <div class="validate_msg_long" id="idcard_no_msg">正确的身份证号码格式</div>
                </div>
                <div class="text_info clearfix"><span>登录账号(登录名)：</span></div>
                <div class="input_info">
                ...
                <div id="optionalInfo" class="hide">
                    ...
                    <div class="input_info">
                        <input type="text" value="" id="birthdate" name="birthdate" readonly="readonly" class="readonly" />
                    </div>
