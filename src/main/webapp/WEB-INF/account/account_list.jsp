...
//                 	location.href ="startAccount.do?id="+id;
										location.href="pauseAccount.do?id="+id+"&status="+0+"&page="+${accountPage.page};
                }
                //document.getElementById("operate_result_info").style.display = "block";
            }
            //暂停
            function setStatusPause(id){
            	...
            	if(r){
                	location.href = "pauseAccount.do?id="+id+"&status="+1+"&page="+${accountPage.page};
                }
            	//document.getElementById("operate_result_info").style.display = "block";
            }
        </script>
        ...
        <div id="main">
            <form action="findAccount.do" method="get">
                ...
                <div class="search_add">                        
                    ...
                    <input type="button" value="增加" class="btn_add" onclick="location.href='addAccountUI.do';" />
                </div>  
                <!--删除等的操作提示-->
