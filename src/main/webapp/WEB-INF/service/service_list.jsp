            	...
            	$.post(
            		...
            		function(data) {
            			...
            			setTimeout(function(){
            				...
            				//如果开通成功，则刷新页面
            				if(data.success) {
            					location.href = "findService.do?page="+${servicePage.page};
            				}
            			},2000);
            		}
            	);
                ...
                <div id="data">            
                    ...
                    <tr>
                        ...
                        <td class="td_modi">
                        	<c:choose>
                        		<c:when test="${s.status==0}">
		                            <input type="button" value="暂停" class="btn_pause" onclick="setState(${s.service_id});" />
