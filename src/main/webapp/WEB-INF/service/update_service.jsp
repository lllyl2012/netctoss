...
<html xmlns="http://www.w3.org/1999/xhtml">
            	...
            	$.post(
            			...
            			function(json){
            				if(json.state == "1"){
            					...
            					$("#save_result_info").text(json.message);
	            				showResultDiv(true);
    ...
    <body>
        ...
        <div id="main">
            ...
            <form id="main_from" action="" method="" class="main_form">
                <!--必填项-->
                ...
                <div class="input_info">
                    <select class="width150" name="cost_id">
											<c:forEach var="i" items="${costs}">
												<option value="${i.cost_id}" <c:if test="${service.cost_id eq i.cost_id}">selected</c:if>>${i.name}</option>
											</c:forEach>
                    </select>
                ...
                <div class="button_info clearfix">
                    ...
                    <input type="button" value="取消" class="btn_save" onclick="location.href='findService.do'"/>
                </div>
